...
class Document(Base, TimestampMixin):
    ...
    observed_quantity: Mapped[float | None] = mapped_column(Float, nullable=True)
    observed_quantity_unit: Mapped[str | None] = mapped_column(String(32), nullable=True)
    observed_expenditure: Mapped[float | None] = mapped_column(Float, nullable=True)
    notes: Mapped[str | None] = mapped_column(Text, nullable=True)
    mime_type: Mapped[str | None] = mapped_column(String(128), nullable=True)
    file_size: Mapped[int | None] = mapped_column(Integer, nullable=True)
    extraction_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
    integrity_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
    duplicate_of_id: Mapped[int | None] = mapped_column(ForeignKey("document.id"), nullable=True)
...
class Photo(Base, TimestampMixin):
    ...
    duplicate_of_id: Mapped[int | None] = mapped_column(ForeignKey("photo.id"), nullable=True)
    integrity_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
    attached_to_evidence: Mapped[int | None] = mapped_column(Integer, nullable=True)
    analysis_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    analysis_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
    forensics_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    forensics_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
...
class Claim(Base, TimestampMixin):
    ...
    claimed_progress_percent: Mapped[float | None] = mapped_column(Float, nullable=True)
    claimed_quantity: Mapped[float | None] = mapped_column(Float, nullable=True)
    claimed_quantity_unit: Mapped[str | None] = mapped_column(String(32), nullable=True)
    claim_date: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    claimant_source: Mapped[str | None] = mapped_column(String(256), nullable=True)
    supporting_document_ids_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    data_mode: Mapped[str | None] = mapped_column(String(32), nullable=True)
    provenance_json: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class PlanArtifact(Base, TimestampMixin):
    ...
    attached_to_plan: Mapped[int | None] = mapped_column(Integer, nullable=True)
    attached_to_evidence: Mapped[int | None] = mapped_column(Integer, nullable=True)
    data_mode: Mapped[str | None] = mapped_column(String(32), nullable=True)
    provenance_json: Mapped[str | None] = mapped_column(Text, nullable=True)
